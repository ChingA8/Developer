...
<div class='front_h_wrap'>
	...
	<h1 class='front_h_msg'>Part-time, entry level, fresh graduate and internship jobs in Malaysia.</h1>
			...
			<input type="text" name="search_location" id="search_location" placeholder="Type Your Location" value="<?php echo esc_attr( $location ); ?>" />
					...
					<div class="job_category">
						...
						foreach($job_categories as $term):
							...
							?>
							<div class='check_wrap'><span class='checkbox_wrap'><input class='search_checkbox <?php echo $f_term; ?>' type="checkbox" name="search_categ[]" value="<?php echo $t_slug; ?>"/></span><span class='categ_span'><?php echo $term_name ?></span></div>
							<?php 
						endforeach;?>
